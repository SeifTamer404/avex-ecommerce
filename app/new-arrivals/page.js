...
export const metadata = {
  title: "New Arrivals",
  description: "Check out the newest products on AVEX.",
  alternates: {
  ...
  return (
    <div className="flex flex-col gap-6 mt-6">
      ...
      <nav aria-label="Breadcrumb" className="flex items-center gap-1.5 text-xs text-[var(--color-inverted-bg)]/40">
        ...
        <span className="text-[var(--color-inverted-bg)]/70 font-medium">New Arrivals</span>
      </nav>
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-sm text-[var(--color-inverted-bg)]/40">
          {total} newly added {total === 1 ? "product" : "products"}
        </p>
      </div>
